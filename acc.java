...
Statement stmt = null;
ResultSet rs= null;
String DB = "jdbc:mysql://localhost/aryan";
int n = 0;
    /**
    ...
    private void initComponents() {
        ...
        jLabel10.setBounds(250, 20, 300, 32);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ssp/bb.jpg"))); // NOI18N
    ...
    private void CreateAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateAccountActionPerformed
        ...
        if (f_name.length()== 0){javax.swing.JOptionPane.showMessageDialog(null,"First name field is empty!");}
        else{
        if (email.length()== 0){ javax.swing.JOptionPane.showMessageDialog(null,"Give the valid E-mail address.");}
        else {
        if(jRadioButton1.isSelected()== true || jRadioButton2.isSelected()== true){String a= "insert into customers values("+ n + ", '"+ f_name + "' , '" + l_name + "' , '"+ email +"' , '"+ pass +"' , '"+ usertype + "' );";
        if(pass.equals(c_pass)){
         ...
         con.close();
            ...
            javax.swing.JOptionPane.showMessageDialog(null,show);
        ...
        else { javax.swing.JOptionPane.showMessageDialog(null,"Fill password correctly.");
        
        }}
        else {javax.swing.JOptionPane.showMessageDialog(null,"Select the User Type");
